...
{
	setName(__String::createWithFormat("level%d_Artillery_",level)->getCString());
	towerBase = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer1_0001.png",level)->getCString());
	leftShooter = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer2_0001.png",level)->getCString());
	rightShooter = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer3_0001.png",level)->getCString());
	barrel = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer4_0001.png",level)->getCString()); 
	smoke = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer5_0001.png",level)->getCString()); 
	c4 = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer6_0001.png",level)->getCString());  
	...
	addChild(smoke);
	addChild(c4);
	addChild(Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_artillery_lvl%d_layer7_0001.png",level)->getCString()));
