...
{
	towerBase = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_barracks_lvl%d_layer1_0001.png",level)->getCString());
	door = Sprite::createWithSpriteFrameName(__String::createWithFormat("tower_barracks_lvl%d_layer2_0001.png",level)->getCString());
	...
	door->runAction(Animate::create(AnimationCache::getInstance()->getAnimation(__String::createWithFormat("level%d_barracks_opendoor",getLevel())->getCString())));
...
void BaseBarracksTower::sellTower()
{
	...
	static_cast<CustomTerrain*>(this->getParent())->terrain->setVisible(true);
	...
	static_cast<CustomTerrain*>(this->getParent())->smokeEffect();
...
void BaseBarracksTower::updateTower()
{
	...
	towerBase -> setSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(__String::createWithFormat("tower_barracks_lvl%d_layer1_0001.png",level)->getCString()));
	door->setSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(__String::createWithFormat("tower_barracks_lvl%d_layer2_0001.png",level)->getCString()));
	for(int i = 0; i< Soldiers.size() ;i++)
	{
