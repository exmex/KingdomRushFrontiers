...
bool Victory::initVictory(int star,int gem)
{
	...
	auto one = Sprite::createWithSpriteFrameName(__String::createWithFormat("win_Gnome_Numbers_000%d.png",gem%10)->getCString());
	auto ten = Sprite::createWithSpriteFrameName(__String::createWithFormat("win_Gnome_Numbers_000%d.png",(gem/10)%10)->getCString());
	...
	{
		frame = SpriteFrameCache::getInstance()->getSpriteFrameByName(__String::createWithFormat("victoryStars_star_00%02d.png",len)->getCString());
		if(frame!=nullptr)
