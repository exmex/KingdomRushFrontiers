...
void MonsterInfoLayer::updateMonsterHp(float dt)
{
	if(mBaseMonster->getCurrHp()<=0){
		...
		hpLabel->setString(__String::createWithFormat("%d/%d",(int)mBaseMonster->getCurrHp(),(int)mBaseMonster->getMaxHp())->getCString());
}
...
void MonsterInfoLayer::setMonsterInfo()
{
	...
	hpLabel->setString(__String::createWithFormat("%d/%d",(int)mBaseMonster->getMaxHp(),(int)mBaseMonster->getMaxHp())->getCString());
	forceLabel->setString(__String::createWithFormat("%d",(int)mBaseMonster->getForce())->getCString());
	armorLabel->setString(__String::createWithFormat("%d",(int)mBaseMonster->getArmor())->getCString());
